...
### [我的博客在这里 &rarr;](http://lugp.github.io)
...
```
# Site settings
title: username             # 你的博客网站标题
SEOTitle: username			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: username     # 你的github账号
weibo_username: username      # 你的微博账号，底部链接会自动更新的。
...
date:       2017-08-16
author:     username
header-img: img/post-bg-test-web.jpg
catalog: 	 true
tags:
    - test
---
...
sidebar-avatar: /img/avatar-test.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
我的博客标题是 **“lugp”** 但是我想要在搜索的时候显示 **“lugp |  Blog”** ，这个就需要 SEO Title 来定义了。
...
1. 这个模板是从这里[qiubaiying](https://github.com/qiubaiying/qiubaiying.github.io) fork 的。非常感谢qiubaiying。
